...
## Acknowledgement
The codebase is adapted from [Qwen2.5-Math](https://github.com/QwenLM/Qwen2.5-Math), which itself is adapted from [math-evaluation-harness](https://github.com/ZubinGou/math-evaluation-harness).
