...
def test_gcd_float():
    ...
    assert_equal(
        "\\operatorname{gcd}(0.0000923423, -8341.234802909)", gcd(Rational("0.0000923423"), Rational("-8341.234802909"))
    )
...
def test_gcd_symbol():
    ...
    assert_equal(
        "y + \\operatorname{gcd}(0.4x, 8/3) / 2", y + gcd(Rational("0.4") * x, Rational("8/3")) / 2, symbolically=True
    )
    assert_equal(
