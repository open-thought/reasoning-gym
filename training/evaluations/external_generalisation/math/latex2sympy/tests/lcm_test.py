...
def test_lcm_float():
    ...
    assert_equal(
        "\\operatorname{lcm}(0.0000923423, -8341.234802909)", lcm(Rational("0.0000923423"), Rational("-8341.234802909"))
    )
...
def test_lcm_symbol():
    ...
    assert_equal(
        "y + \\operatorname{lcm}(0.4x, 8/3) / 2", y + lcm(Rational("0.4") * x, Rational("8/3")) / 2, symbolically=True
    )
    assert_equal(
